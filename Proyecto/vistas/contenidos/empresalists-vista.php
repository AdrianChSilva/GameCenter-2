...
<div class="container-fluid">
    ...
    <p class="lead">Aquí se muestra una lista con todas las empresas. Si eres administrador de nivel 1 podrás eliminar y actualizar. Si eres de nivel 2 sólo podrás actualizar</p>
</div>

<div class="container-fluid">
    <ul class="breadcrumb breadcrumb-tabs">
        <li>
            <a href="<?php echo SERVERURL ?>empresa/" class="btn btn-info">
                <i class="zmdi zmdi-plus"></i> &nbsp; NUEVA EMPRESA
            </a>
        </li>
        <li>
            <a href="<?php echo SERVERURL ?>empresalists/" class="btn btn-success">
